...
The following screenshots provide evidence of the payment flow from initialization through successful payment:

### Payment Initialization

![Payment initialization](screenshots/initialize_payment.png)
